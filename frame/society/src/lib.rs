...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		/// # </weight>
		#[pallet::weight(T::WeightInfo::found())]
		pub fn found(
			origin: OriginFor<T>,
			founder: T::AccountId,
			max_members: u32,
		...
		/// Total Complexity: O(1)
		/// # </weight>
		#[pallet::weight(T::WeightInfo::unfound())]
		...
		/// # </weight>
		#[pallet::weight(T::WeightInfo::judge_suspended_candidate())]
		...
		/// Total Complexity: O(1)
		/// # </weight>
		#[pallet::weight(T::WeightInfo::set_max_members())]
